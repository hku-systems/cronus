...
extern "C" int vta_main(void) {
  ...
  status |= blocked_gemm_test(512, 512, VTA_BLOCK_OUT*4, true, 2);
  status |= blocked_gemm_test(512, 512, VTA_BLOCK_OUT*4, true, 2);
  status |= blocked_gemm_test(512, 512, VTA_BLOCK_OUT*4, true, 2);
  status |= blocked_gemm_test(512, 512, VTA_BLOCK_OUT*4, true, 2);
  // status |= blocked_gemm_test(512, 512, VTA_BLOCK_OUT*4, false, 2);
