...
// import from muslc malloc for compatibility
#define malloc __libc_malloc_impl
#define realloc __libc_realloc
#define calloc __libc_calloc_impl
...
void *aligned_alloc(size_t align, size_t len) {
	// TODO: check that len is the multiple of align
	if (len % align > 0) return NULL;
