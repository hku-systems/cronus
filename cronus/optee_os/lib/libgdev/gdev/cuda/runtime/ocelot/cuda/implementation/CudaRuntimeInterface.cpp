...
cudaError_t cuda::CudaRuntimeInterface::cudaLaunchKernel(const void *func, dim3 gridDim, dim3 blockDim,
...
cudaError_t cuda::CudaRuntimeInterface::cudaFuncGetParameters(
	uint32_t *n_par, uint32_t parameters[20], const char *func) {
	assert(0 && "unimplemented");
	return cudaErrorNotYetImplemented;
}
