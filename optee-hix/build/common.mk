...
linux-common: linux-defconfig
	# $(MAKE) -C $(LINUX_PATH) LOCALVERSION= CROSS_COMPILE=$(CROSS_COMPILE_NS_KERNEL) INSTALL_MOD_PATH=build-modules ARCH=arm64 modules
	# $(MAKE) -C $(LINUX_PATH) LOCALVERSION= CROSS_COMPILE=$(CROSS_COMPILE_NS_KERNEL) INSTALL_MOD_PATH=build-modules ARCH=arm64 modules_install
